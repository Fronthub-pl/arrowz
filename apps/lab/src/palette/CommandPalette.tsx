      ...
      <div className="fw-pal" role="dialog" aria-modal="true" aria-label={title} ref={frameRef}>
        ...
        <div className="foot">
          ...
          {/* The footer follows the keys, not the dialog (spec §7). ⌘K opens
              ...
              to forbid the mock for printing. `r` is bound by `useReportKey`
              on the lab tab alone (index 0): the saved boards have no
              drawer, so there the hint goes while `g` and `[ ]` stay. */}
          {onWorkspace ? (
            <>
              <span>
