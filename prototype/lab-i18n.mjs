...
export const PL = {
  ...
  params: {
    ...
    wShort: { label: 'udział krótkich (2–6 komórek)',
      help: 'Jaka część elementów ma być krótka. Wyżej = więcej grotów, ale sieczka z haczyków. Krótkie i średnie razem nie mogą przekroczyć 0,9.' },
    wMid: { label: 'udział średnich (7–15 komórek)',
      help: 'Jaka część elementów ma być średnia. Reszta po krótkich i średnich idzie na długie. Krótkie i średnie razem nie mogą przekroczyć 0,9.' },
    ...
    warns: { label: 'domykanie zakamarków',
      help: 'Jak mocno linia najpierw wypełnia zakamarki z małą liczbą wyjść. Wyżej = mniej elementów, dłuższe i zwinięte. Poniżej 2 reguła nie działa i plansze się zacinają.' },
    anticoil: { label: 'kara za zwijanie',
      help: 'Jak mocno linia unika dotykania samej siebie. 1 = wyłączone. Wyżej = mniej zwojów, nieco krótsze elementy. Powyżej 10 zacina się przy małej skłonności do prostej.' },
    ...
    wGiant: { label: 'udział szkieletów poza startem',
      help: 'Szansa, że element wycinany później też będzie szkieletem. Powyżej 0,2 plansze robią się wolne i przestają się domykać przy 1000×1000.' },
    giantStraight: { label: 'skłonność szkieletu do prostej',
      help: 'Jak chętnie szkielet idzie prosto tam, gdzie rośnie swobodnie: cała linia przy skoku 0, ogon po serpentynie. Poniżej 0,3 plansze przestają się domykać.' },
    giantWarns: { label: 'domykanie zakamarków dla szkieletu',
      help: 'Reguła zakamarków tylko dla szkieletu, tam gdzie rośnie swobodnie. Zostaw 0: zwija linię, a szkielet ma iść daleko.' },
    ...
    giantSpacing: { label: 'promień odstępu szkieletu',
      help: 'Jak daleko szkielet trzyma się od własnych wcześniejszych biegów, w komórkach. Powyżej 3 tylko kosztuje czas.' },
    ...
    headTries: { label: 'prób startu na kierunek',
      help: 'Ile miejsc startu wypróbować przed zmianą kierunku. 1 głodzi szukanie przy trudnych ustawieniach; powyżej 16 tylko kosztuje czas.' },
    strandLimit: { label: 'dokładny test resztki do N komórek',
      help: 'Do jakiego rozmiaru wolny fragment jest sprawdzany dokładnie, czy da się pociąć. Poniżej 10 na dużych planszach prześlizgują się resztki po 10 komórek.' },
    absorbLimit: { label: 'wchłanianie resztek do N komórek',
      help: 'Fragment do tego rozmiaru, którego nie da się wyciąć, dokleja się do sąsiada. Poniżej 12 resztki się piętrzą i plansze się zacinają.' },
    maxBack: { label: 'budżet nawrotów (0 = 200)',
      help: 'Ile wycięć wolno cofnąć w jednej próbie, zanim zacznie się od nowa. 0 = 200, to wystarcza; więcej tylko opóźnia werdykt.' },
    restarts: { label: 'dopuszczalne restarty',
      help: 'Ile nowych prób z pochodnym ziarnem po nieudanej. 0 pokazuje surową skuteczność ustawień; więcej niż 5 prawie nigdy nie pomaga.' },
  },
  groupHelp: {
  ...
  ui: {
    ...
    headHelp: 'Automat: poniżej grubości 0,5 strzałka 0,4 + 0,9 grubości szeroka i 0,9 wysoka; od 0,5 zaostrzony kijek szerokości linii, 1,4 grubości wysoki. Grot węższy od linii jest do niej poszerzany.',
...
export const EN = {
  ...
  ui: {
    ...
    headHelp: 'Automatic: under a stroke of 0.5 an arrow 0.4 + 0.9 stroke wide and 0.9 tall; from 0.5 a sharpened stick as wide as the line, 1.4 strokes tall. A head narrower than the line is widened to it.',
